...
public class BurningScreen extends GLScreen{
	 Camera2D guiCam;
	 ...
	 public BurningScreen(Game game)
	 {
		 super(game);
		 guiCam = new Camera2D(glGraphics, 320, 480);
	     batcher = new SpriteBatcher(glGraphics, 100);
	     nextBounds = new Rectangle(205,480-469,104,32);
	     backBounds = new Rectangle(32,480-469,104,32);
	        ...
	        for(int i = 0; i < len; i++) {
	            ...
	            if(event.type == TouchEvent.TOUCH_UP) {
	                if(OverlapTester.pointInRectangle(nextBounds, touchPoint)) {
	                    ...
	                    game.setScreen(new BirdsScreen((Game) game));
	                    return;
	                }
	 ...
	 @Override
		public void present(float deltaTime) {
	        ...
	        batcher.drawSprite(160, 240, 320, 480, Assets.burningRegion);
	        batcher.endBatch();
