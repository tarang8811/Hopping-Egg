...
public class BirdsScreen extends GLScreen{
	 Camera2D guiCam;
	        ...
	        for(int i = 0; i < len; i++) {
	            ...
	            if(event.type == TouchEvent.TOUCH_UP) {
	                if(OverlapTester.pointInRectangle(nextBounds, touchPoint)) {
	                    ...
	                    game.setScreen(new CountDownScreen((Game) game));
	                    return;
	                }
	 ...
	 @Override
		public void present(float deltaTime) {
	        ...
	        batcher.drawSprite(160, 240, 320, 480, Assets.birdRegion);
	        batcher.endBatch();
